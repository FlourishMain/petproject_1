...
export default function Footer() {
  return (
    <div className="footer">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 px-[80px] footer__nav-wrapper">
        {Schema.navs.length &&
          Schema.navs.map((e) => {
            return (
              <div
                className={`
                  flex flex-col  py-[40px] footer__nav-section lg:border-r-[2px] border-r-[#8589af]
                `}
              >
        ...
        <div className="footer__location-section py-[40px] footer__nav-section lg:border-r-[2px] border-r-[#8589af]">
        ...
        <div className="footer__twitter-section py-[40px] footer__nav-section lg:border-r-[2px] border-r-[#8589af]">
          <div className="flex flex-col">
            ...
            <div className="mt-[24px]">
              ...
              <div className="mt-[16px] text-white max-w-[380px]">
